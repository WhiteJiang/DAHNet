...
def load_data(root, batch_size, num_workers):
    ...
    print("query dataset:", len(query_dataset))
...
class Cub2011(Dataset):
    ...
    def init(root):
        ...
        # target组成为图片序号以及对应的标签 序号为键值,标签作为关键值
        # print("train_data['target']", train_data['target'])
        # print("test_data['target']", (train_data['target'] - 1))
...
if __name__ == '__main__':
    query_dataloader, train_dataloader, retrieval_dataloader = load_data(
        '/opt/data/private/ML_DATA/CUB_200_2011',
        16,
        8,
    )
